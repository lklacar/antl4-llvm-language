...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\2\7\2(\n\2\f\2\16\2+\13\2\3\3\3\3\3\3\3\3\3\3\3\4\3")
        buf.write("\4\3\4\3\4\3\4\3\4\3\5\3\5\3\5\3\6\5\6<\n\6\3\6\3\6\7")
        buf.write("\6@\n\6\f\6\16\6C\13\6\3\7\7\7F\n\7\f\7\16\7I\13\7\3\b")
        buf.write("\3\b\3\b\5\bN\n\b\3\t\3\t\3\t\3\n\3\n\3\n\3\n\3\n\3\13")
        buf.write("\3\13\3\13\3\13\3\13\3\13\7\13^\n\13\f\13\16\13a\13\13")
        buf.write("\3\13\3\13\3\f\3\f\3\f\3\f\3\f\3\f\3\f\7\fl\n\f\f\f\16")
        buf.write("\fo\13\f\3\f\5\fr\n\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f")
        buf.write("\3\f\7\f}\n\f\f\f\16\f\u0080\13\f\3\r\3\r\3\r\3\r\3\16")
        buf.write("\3\16\3\17\3\17\3\20\5\20\u008b\n\20\3\20\3\20\7\20\u008f")
        ...
        buf.write("\2?=\3\2\2\2@C\3\2\2\2A?\3\2\2\2AB\3\2\2\2B\13\3\2\2\2")
        buf.write("CA\3\2\2\2DF\5\16\b\2ED\3\2\2\2FI\3\2\2\2GE\3\2\2\2GH")
        buf.write("\3\2\2\2H\r\3\2\2\2IG\3\2\2\2JN\5\22\n\2KN\5\20\t\2LN")
        ...
        buf.write("\5\32\16\2\u0083\u0084\5\26\f\2\u0084\31\3\2\2\2\u0085")
        buf.write("\u0086\t\4\2\2\u0086\33\3\2\2\2\u0087\u0088\5\26\f\2\u0088")
        buf.write("\35\3\2\2\2\u0089\u008b\5\34\17\2\u008a\u0089\3\2\2\2")
        buf.write("\u008a\u008b\3\2\2\2\u008b\u0090\3\2\2\2\u008c\u008d\7")
        buf.write("\3\2\2\u008d\u008f\5\34\17\2\u008e\u008c\3\2\2\2\u008f")
...
class CodeParser ( Parser ):
    ...
    ruleNames =  [ "program", "function", "functionHead", "arg", "arguments", 
                   ...
                   "ifStatement", "expression", "equation", "relop", "param", 
                   "params", "functionCall", "atom", "type" ]
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def function(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CodeParser.FunctionContext)
            else:
                return self.getTypedRuleContext(CodeParser.FunctionContext,i)
    ...
    def program(self):
        ...
        try:
            ...
            while _la==CodeParser.T__3 or _la==CodeParser.T__4:
                self.state = 36
                self.function()
                self.state = 41
                self._errHandler.sync(self)
    ...
    class FunctionContext(ParserRuleContext):
        ...
        def functionHead(self):
            return self.getTypedRuleContext(CodeParser.FunctionHeadContext,0)
    ...
    def function(self):
        ...
        localctx = CodeParser.FunctionContext(self, self._ctx, self.state)
    ...
    def functionHead(self):
        ...
        localctx = CodeParser.FunctionHeadContext(self, self._ctx, self.state)
    ...
    def arg(self):
        ...
        localctx = CodeParser.ArgContext(self, self._ctx, self.state)
    ...
    class ArgumentsContext(ParserRuleContext):
        ...
        def arg(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CodeParser.ArgContext)
            else:
                return self.getTypedRuleContext(CodeParser.ArgContext,i)
    ...
    def arguments(self):
        ...
        localctx = CodeParser.ArgumentsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if _la==CodeParser.T__3 or _la==CodeParser.T__4:
                self.state = 56
                self.arg()
    ...
    def functionBody(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << CodeParser.T__1) | (1 << CodeParser.T__2) | (1 << CodeParser.T__3) | (1 << CodeParser.T__4))) != 0):
                self.state = 66
                self.statement()
                self.state = 71
                self._errHandler.sync(self)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def returnStatement(self):
            return self.getTypedRuleContext(CodeParser.ReturnStatementContext,0)


        def ifStatement(self):
            return self.getTypedRuleContext(CodeParser.IfStatementContext,0)
    ...
    def statement(self):
        ...
        try:
            ...
            if token in [CodeParser.T__3, CodeParser.T__4]:
                self.enterOuterAlt(localctx, 1)
                self.state = 72
                self.assignmentStatement()
                pass
            elif token in [CodeParser.T__1]:
                self.enterOuterAlt(localctx, 2)
                self.state = 73
                self.returnStatement()
                pass
            elif token in [CodeParser.T__2]:
    ...
    def returnStatement(self):
        ...
        localctx = CodeParser.ReturnStatementContext(self, self._ctx, self.state)
    ...
    class IfStatementContext(ParserRuleContext):
        ...
        def equation(self):
            return self.getTypedRuleContext(CodeParser.EquationContext,0)
        ...
        def getRuleIndex(self):
            return CodeParser.RULE_ifStatement
    ...
    def ifStatement(self):
        ...
        localctx = CodeParser.IfStatementContext(self, self._ctx, self.state)
    ...
    class EquationContext(ParserRuleContext):
        ...
        def relop(self):
            return self.getTypedRuleContext(CodeParser.RelopContext,0)


        def getRuleIndex(self):
            return CodeParser.RULE_equation
    ...
    def equation(self):
        ...
        localctx = CodeParser.EquationContext(self, self._ctx, self.state)
        self.enterRule(localctx, 22, self.RULE_equation)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 127
            self.expression(0)
    ...
    def param(self):
        ...
        localctx = CodeParser.ParamContext(self, self._ctx, self.state)
    ...
    class ParamsContext(ParserRuleContext):
        ...
        def param(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CodeParser.ParamContext)
            else:
                return self.getTypedRuleContext(CodeParser.ParamContext,i)
    ...
    def params(self):
        ...
        localctx = CodeParser.ParamsContext(self, self._ctx, self.state)
    ...
    def functionCall(self):
        ...
        localctx = CodeParser.FunctionCallContext(self, self._ctx, self.state)
    ...
    class AtomContext(ParserRuleContext):
        ...
        def DECIMAL(self):
            return self.getToken(CodeParser.DECIMAL, 0)
    ...
    def type(self):
        ...
        try:
            ...
            self.state = 155
            _la = self._input.LA(1)
            if not(_la==CodeParser.T__3 or _la==CodeParser.T__4):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
